            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Edit Gambar</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
              ...
              <?php 
                                        ...
                                        $id = $_GET['id'];
                                        $data = mysqli_query($kon,"select * from gambar where id='$id'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
              <form method="post" action="proseseditgambar.php"enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <img src="../assets/img/gallery/<?php echo $d['nama_file']; ?>" style="width:150px;height:100px;" alt="<?php echo $d['judul']; ?>">
